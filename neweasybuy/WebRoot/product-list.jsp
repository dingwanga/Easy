	...
	<div class="main">
		<div class="product-list">
			...
			<c:forEach items="${pageBean.pageList}" var="product">
				<li>
					<dl>
						<dt><a href="productviewServlet?id=${product.epId}" target="_self"><img src="files/${product.epFileName}" /></a></dt>
						<dd class="title"><a href="productviewServlet?id=${product.epId}" target="_self">${product.epName}</a></dd>
			...
			<div class="pager">
				<ul class="clearfix">
					<li>当前页/总页数: ${pageBean.currPageNo}
					/${pageBean.totalPageCount}</li>
				<c:if test="${pageBean.currPageNo>1}">
					<li><a href="productlistServlet?pageNo=1">首页</a></li>
					<li><a href="productlistServlet?pageNo=${pageBean.currPageNo-1 }">上一页</a>
					</li>
				</c:if>
				<c:if test="${pageBean.currPageNo<pageBean.totalPageCount}">
					<li><a href="productlistServlet?pageNo=${pageBean.currPageNo+1 }">下一页</a>
					</li>
					<li><a
						href="productlistServlet?pageNo=${pageBean.totalPageCount}">末页</a></li>
				</c:if>
				</ul>
			</div>
		</div>
