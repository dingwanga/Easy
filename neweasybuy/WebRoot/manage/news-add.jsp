...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>添加新闻</h2>
		<div class="manage">
			<form id="newsAdd" action="newsAddServlet" method="post" id="form">
				<table class="form">
					<tr>
						<td class="field">新闻标题：</td>
						<td><input type="text" class="text" name="title" value="" id="title"/><span id="til"></span></td>
					</tr>
					<tr>
						<td class="field">新闻内容：</td>
						<td><textarea class="text" name="content" id="content"></textarea><span id="con"></span ></td>
					</tr>
					<tr>
						<td></td>
