...
<body>
	...
	<div id="main" class="wrap">
		...
		<div class="main">
			<h2>修改分类</h2>
			<div class="manage">
				<form action="pcaResultServlet?id=${pc.epcId}" method="post">
					<table class="form">
						<tr>
							<td class="field">父分类：</td>
							<td><select name="parentId">
									<option value="0">根栏目</option>
									<c:forEach items="${li}" var="pca">
									<option value="${pca.epcId}" 
									<c:if test="${pca.epcId==pc.epcParentId}">selected="selected" </c:if>
									>${pca.epcName}</option>
									</c:forEach>
