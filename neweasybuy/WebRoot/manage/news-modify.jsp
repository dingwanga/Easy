...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>修改新闻</h2>
		<div class="manage">
			<form action="newsresultServlet?id=${news.enId}" method="post">
				<table class="form">
					<tr>
						<td class="field">新闻标题：</td>
						<td><input type="text" class="text" name="title" value="${news.enTitle}" /></td>
					</tr>
					<tr>
						<td class="field">新闻内容：</td>
						<td><textarea name="content">${news.enContent}</textarea></td>
					</tr>
					<tr>
						<td></td>
